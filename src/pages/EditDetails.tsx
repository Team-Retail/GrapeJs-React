...
export default function EditDetails() {
  ...
  const getDefaultEntry = async () => {
    ...
    setFormData({
      company_instagram: userDetailsResponse.data.response.companySocialMediaHandle.insta,
      company_address: userDetailsResponse.data.response.companyLocation,
      company_twitter: userDetailsResponse.data.response.companySocialMediaHandle.twitter,
      company_website: userDetailsResponse.data.response.companyWebsiteUrl
    });
